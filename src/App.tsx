  ...
  const [reviews, setReviews] = useState([
    {
      ...
      text: "The care I received at Jeevan Astra Hospital was exceptional. The surgical team was skilled, and the nursing staff was incredibly attentive during my recovery.",
      rating: 5,
      initial: "AD",
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 overflow-x-hidden relative">
      ...
      <div className="bg-maroon min-h-[32px] py-1 text-white px-4 md:px-10 text-[10px] md:text-[11px] font-medium flex flex-col md:flex-row justify-between items-center gap-2 md:gap-0 tracking-[0.5px] uppercase relative z-[60]" role="status" aria-label="Quick contact information">
        <div className="flex items-center space-x-4 md:space-x-6">
          <span className="flex items-center gap-2">Durgapur City Center</span>
        </div>
        <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
          <a href="tel:+918001891036" className="flex items-center gap-1.5 hover:text-coral transition-colors outline-none focus-visible:ring-1 focus-visible:ring-white">Emergency: +91 80018 91036</a>
      ...
      <header className="sticky top-0 z-50 bg-white h-16 md:h-20 flex items-center border-b border-gray-100">
        <nav className="w-full px-4 md:px-10 flex justify-between items-center" aria-label="Main navigation">
          ...
          <button 
            ...
            aria-label="Jeevan Astra Hospital Home"
          >
            ...
            <div>
              <span className="text-base md:text-xl font-black tracking-tight text-navy leading-none block">JEEVAN ASTRA</span>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                <button 
                  onClick={() => window.location.href = 'tel:+918001891036'}
      ...
      <section id="vision" className="relative py-24 bg-navy overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-6 md:px-10">
           <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 px-3 py-1 rounded-full mb-8">
              <span className="text-white uppercase tracking-[2px] text-[9px] font-bold">Jeevan Astra</span>
           </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            ...
            <p className="text-slate-500 max-w-sm text-sm leading-relaxed mb-2 font-medium">
              We combine advanced medical technology with human compassion to provide the best healthcare services in Durgapur City Center.
            </p>
          </div>
      ...
      <section className="bg-navy py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10 text-center">
          ...
          <p className="text-white/60 text-xl font-medium max-w-2xl mx-auto leading-relaxed">
            Jeevan Astra Super-Specialty Hospital is dedicated to providing world-class healthcare with a human touch, merging cutting-edge technology with compassionate expertise.
          </p>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 font-bold uppercase tracking-widest text-xs">The pillars that define Jeevan Astra</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-slate-500 font-medium leading-relaxed">
              Jeevan Astra Hospital, Durgapur City Center
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-2 text-slate-500 font-bold mt-auto">
              <a href="tel:+918001891036" className="block hover:text-maroon transition-colors">Tel: +91 80018 91036</a>
            </div>
          </motion.div>
      ...
      <div className="bg-[#080d17] pt-20 pb-12 px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 border-b border-white/5 pb-16">
            ...
            <div className="space-y-8">
               ...
               >
                  ...
                  <div>
                    <h3 className="text-white font-black text-xl leading-none mb-1 text-nowrap">JEEVAN ASTRA</h3>
               ...
               <div className="space-y-5">
                 ...
                 <div className="flex gap-4">
                   ...
                   <div className="text-slate-400 text-sm font-medium">
                      <a href="tel:+918001891036" className="block hover:text-coral transition-colors">+91 80018 91036</a>
                   </div>
                 </div>
                 <div className="flex gap-4">
                   <div className="w-10 h-10 rounded-lg bg-coral/10 flex items-center justify-center text-coral shrink-0">
          ...
          <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-6 text-[11px] font-bold text-white/30 uppercase tracking-[1px]">
             <p>© 2026 Jeevan Astra Hospital. All rights reserved.</p>
